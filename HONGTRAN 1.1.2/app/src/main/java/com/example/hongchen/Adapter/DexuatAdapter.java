...
public class DexuatAdapter extends RecyclerView.Adapter<DexuatAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.textviewdscasi.setText(baihat.getCaSi());
        holder.textviewdsluotthich.setText(baihat.getLuotThich() + " lượt yêu thích");
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView textviewdexuat, textviewdscasi, textviewdsluotthich;
        ImageView imageviewdexuat;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            textviewdexuat = itemView.findViewById(R.id.textviewtendexuat);
            textviewdscasi = itemView.findViewById(R.id.textviewdscasi);
            textviewdsluotthich = itemView.findViewById(R.id.textviewdsluotthich);
